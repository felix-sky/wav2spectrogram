...
namespace sp
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
    // 2022/8/19
    // Modified by Felix Fung
    // Using blackman as window for spectrogram
    ////////////////////////////////////////////////////////////////////////////////////////////
    template <class T1>
    arma::cx_mat specgram_bl(const arma::Col<T1>& x, const arma::uword Nfft=512, const arma::uword Noverl=256)
    {
        arma::cx_mat Pw;
